...
//       // Adjust the selected date to IST (UTC +5:30)
//       const offset = 5.5 * 60 * 60 * 1000; // IST is UTC +5:30, convert to milliseconds
//       const adjustedDate = new Date(date.getTime() + offset); // Adjust the date to IST
  
//       const formattedDate = adjustedDate.toISOString().split("T")[0]; // Get the date part (YYYY-MM-DD)
...
//     return (
//       <View style={styles.container}>
//         <Text style={styles.ert}>No audit details found</Text>
//       </View>
//     );
//   }
...
//           </>
//         ) : (
//           <Text style={styles.ert}>No data found!</Text>
//         )}
//       </ScrollView>
